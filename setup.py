...
setup(
    ...
    install_requires=['arch==4.*,>=4.15.0', 'google-api-python-client', 'google-cloud-core==1.*,>=1.4.3', 'google-cloud-storage==1.*,>=1.32.0', 'matplotlib==3.*,>=3.3.2', 'numba==0.*,>=0.51.2', 'numpy==1.*,>=1.19.2', 'pandas==1.*,>=1.1.2', 'pandas-gbq==0.14.0', 'pyedflib==0.*,>=0.1.18', 'scikit-learn==0.*,>=0.23.2', 'scikit-plot', 'scipy==1.4.1', 'six==1.*,>=1.13.0', 'sklearn==0.*,>=0.0.0', 'sktime==0.*,>=0.4.3', 'sktime-dl==0.*,>=0.1.0', 'statsmodels==0.*,>=0.12.0', 'tensorflow==2.2.0', 'tsfresh==0.*,>=0.17.0', 'xlrd==1.*,>=1.2.0'],
